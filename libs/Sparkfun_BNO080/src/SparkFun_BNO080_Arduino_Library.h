...
#ifndef SPARKFUN_BNO080_H
#define SPARKFUN_BNO080_H
...
{
public:
	boolean begin(TwoWire &wirePort, uint8_t deviceAddress = BNO080_DEFAULT_ADDRESS, uint8_t intPin = 255); //By default use the default I2C addres, and use Wire port, and don't declare an INT pin
